#!/usr/bin/env bash
# query-watsonx-agent.sh – A non-interactive script to call the watsonx-agent.
set -euo pipefail
...
# --- 4) Get Prompt from Command-Line ---
# Use the first argument as the prompt, or a default if not provided.
DEFAULT_PROMPT="What is the capital of Italy?"
